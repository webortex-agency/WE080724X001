import { Container,Card,Button,Grid, TextField, Typography } from "@mui/material";
      ...
      <Grid container sx={{marginTop:10,marginBottom:10,backgroundColor:"#222222",width:"100%",borderRadius:3,display:"flex",justifyContent:"center"}}>
        ...
        <Container sx={{display:"flex",justifyContent:"space-between",marginBottom:10}}>
            <Card xs={12}
                 ...
                 md={3}
                 lg={3}
                 xl={3} sx={{borderRadius:4,backgroundSize:"cover",height:"280px",width:"300px",backgroundImage:"url('https://s3-alpha-sig.figma.com/img/5cc3/a7a6/41a89057f8d063a0f819598147e75e09?Expires=1724630400&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=ThlSkQSM3dbLY05fAS~luCELB5Am~f69bXD~olZ7jligV5R4kYzq9k4USFlc~a8pMiaXDjK1iE3HnPdBJnuw1HNDkGuNU1FOUsKpVzYp6vAGIf7TZHBKuvevqNvxJXpsxu0UBrRhIfqxbtNZT3p-28dEL0Otg3ZUyxy1FGkBvrOxdXbduWE1cCMMPVtgHT-dcTxp80GNFC1SL9JCj7PZgo1VWH4gVcOEYmehCyyk3CSjW2Ft7IuD-ffJETJMg5UhFgfYNuqgphpSnKDKWCK5nal2ZV1yMPRfu6su-MEjOqAyfTwK5FSgDaKsaHDN6-DMikSqhD89LuWisxc7o5DT~g__')"}}>
                <Typography sx={{backgroundColor:"#D9D9D9",opacity:"44%",color:"white",font:"100%"}}>Hello</Typography>
            </Card>
            <Card xs={12}
                 sm={12}
                 md={3}
                 lg={3}
                 xl={3} sx={{backgroundSize:"cover",height:"280px",width:"300px",backgroundImage:"url('https://s3-alpha-sig.figma.com/img/5cc3/a7a6/41a89057f8d063a0f819598147e75e09?Expires=1724630400&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=ThlSkQSM3dbLY05fAS~luCELB5Am~f69bXD~olZ7jligV5R4kYzq9k4USFlc~a8pMiaXDjK1iE3HnPdBJnuw1HNDkGuNU1FOUsKpVzYp6vAGIf7TZHBKuvevqNvxJXpsxu0UBrRhIfqxbtNZT3p-28dEL0Otg3ZUyxy1FGkBvrOxdXbduWE1cCMMPVtgHT-dcTxp80GNFC1SL9JCj7PZgo1VWH4gVcOEYmehCyyk3CSjW2Ft7IuD-ffJETJMg5UhFgfYNuqgphpSnKDKWCK5nal2ZV1yMPRfu6su-MEjOqAyfTwK5FSgDaKsaHDN6-DMikSqhD89LuWisxc7o5DT~g__')"}}>
                Hello
            </Card>
            <Card xs={12}
                 sm={12}
