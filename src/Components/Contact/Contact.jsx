      ...
      >
        ...
        <Grid
          ...
          sx={{
            ...
            gap: { xs: 10, sm: 10, md: 20, lg: 20, xl: 20 },
            flexDirection: "row",
            marginTop: 10,
          }}
        >
          ...
          >
            <Grid item m={3}>
              ...
              <Typography
                sx={{ color: "white", fontSize: "23px", marginTop: "8px" }}
              >
              ...
              <Typography
                sx={{
                  ...
                  marginLeft: "40px",
                  paddingRight: "100px",
                  fontSize: { sm: "20px", md: "17px", lg: "18px", xl: "18px" },
                }}
              >
          ...
          >
            <Grid item m={3}>
              ...
              <Typography sx={{ color: "#C0BEBE", marginLeft: "40px" }}>
                +91 8888884565
              </Typography>
            </Grid>
          </Grid>
