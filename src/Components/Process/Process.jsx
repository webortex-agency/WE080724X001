...
import process2_1 from '../../assets/process2_1.svg';
import process2_2 from '../../assets/process2_2.svg';
import process2_3 from '../../assets/process2_3.svg';
...
export default function Process() {
  ...
  }, [controls1, controls2_1, controls2_2, controls2_3, controls3, inView1, inView2_1, inView2_2, inView2_3, inView3]);
    ...
    >
      <div className='flex-col flex justify-center items-center'>
        ...
        <div style={{ width: '500px' }}>
          <Typography sx={{ fontSize: '15px', textAlign: 'center', marginTop: '20px' }}>03 . Process</Typography>
          <Typography sx={{ fontSize: '40px', textAlign: 'center', marginBottom: '50px' }}>A simple, yet powerful and efficient process</Typography>
        </div>
      </div>
      <TimelineItem>
        ...
        <TimelineSeparator>
          <div className="flex items-center justify-center w-16 h-16 bg-gray-300 rounded-full" style={{ backgroundColor: '#FFD1C8' }}>
            <div className="flex items-center justify-center w-10 h-10 bg-gray-600 rounded-full" style={{ backgroundColor: '#FFFFFF' }}>
              <span className="text-black text-lg font-bold">1</span>
            </div>
          </div>
          <TimelineConnector sx={{ borderStyle: 'dotted', borderWidth: '2px' }} />
        </TimelineSeparator>
      ...
      <TimelineItem>
        ...
        >
          <div className='flex flex-col justify-start items-start py-0'>
            ...
            <div ref={ref2_2} className="flex justify-start items-start w-full pr-4" style={{marginTop:'-100px'}}>
              <motion.img
                src={process2_2}
            ...
            <div ref={ref2_3} className="flex justify-start items-start w-full pr-4" style={{marginTop:'-100px'}}>
              <motion.img
                src={process2_3}
      ...
      <TimelineItem>
        <TimelineOppositeContent
          sx={{ display: 'flex', justifyContent: 'flex-end', alignItems: 'flex-start', marginTop: '-100px' }}
          color="text.secondary"
        >
        ...
        <TimelineContent sx={{ py: '12px', px: 2, marginTop: '-20px' }}>
          ...
          >
            ...
            <Typography sx={{ fontSize: '18px' }}>
              As previously stated, we are here to support your growth and we nearly guarantee that you will see 100% success in your digital or social media marketing endeavors.
            </Typography>
          </motion.div>
        </TimelineContent>
      </TimelineItem>
