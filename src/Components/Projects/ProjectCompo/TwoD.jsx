...
import Project01 from "../../../assets/Projects/2DProjects/2DProject1.png";
import Project02 from "../../../assets/Projects/2DProjects/2DProject2.png";
  ...
  const twoDProjects = [
    {
      id: 1,
      videoId:
        "https://drive.google.com/file/d/1tHMPp92quYXtbK1LOD7mOruOd1BdtD6u/preview",
      thumbnail: Project01,
      btnText: "Project 1",
    },
    {
      id: 2,
      videoId:
        "https://drive.google.com/file/d/1rAadI5nu-uC7f0U7P7JphBBRrf7r1Zr9/preview",
      thumbnail: Project02,
      btnText: "Project 2",
    },
  ];
        ...
        <Box className="grid grid-flow-row grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-y-8 gap-x-5 pt-4">
          {twoDProjects.map((twoDProject) => (
            <Box
              ...
              onClick={() => handleClickOpen(twoDProject.videoId)}
            >
              <video
                className="w-full h-full object-cover"
                poster={twoDProject.thumbnail}
              >
                <source src={twoDProject.videoId} type="video/mp4" />
              </video>
